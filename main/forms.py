...
# NOTE : Les anciens formulaires `InscriptionEtape2Form`, `InscriptionEtape3Form`
# et `InscriptionEtape4Form` ont été retirés avec la suppression de l'ancien flux
# d'inscription externe publique. Le portail d'admission (`/admissions/`) utilise
# désormais ses propres formulaires (cf. `admissions/preinscription_forms.py`).
